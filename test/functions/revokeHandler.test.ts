...
describe("handler", () => {
  ...
  it("should return 202 response with expected body", async () => {
    ...
    expect(putObject).toHaveBeenCalledWith(
      ...
      "eyJhbGciOiJFUzI1NiIsImtpZCI6InRlc3Qta2V5LWlkIiwidHlwIjoic3RhdHVzbGlzdCtqd3QifQ..mockJoseSignature",
    );
